...
{The goal of this paper is to provide an overview of two related NLP tasks: Text reduction and text simplification.  Both tasks share a common goal of preserving important information, while reducing the complexity of the text as a whole. Discourse information offers a promising means to identify important information in a text, and this paper will present example systems in which discourse information has been used to benefit compression and simplification tasks.  Examples of systems which use a translation based approach to compression/simplification will also be discussed for a look at alternative state of the art systems.  Attention will be given to the general model of each system, comparisons of methods, and the data for training each system. The conclusion will be reserved for a general discussion of discourse information in tasks which aim to reduce text and preserve information.}
\noindent
